...
class DataLinReg:
    def __init__(self):
        ...
        self.data_directory = r'temp_data_v6\(0.02_20_0.1)\mean_diff_0.4_pca_90'
    ...
    def data_read(self):
        ...
        #将train的数据进行分割，用于训练
        (self.train_X, self.train_Y, self.cv_X, self.cv_Y) = two_data_split_unlabel(self.new_data['训练'], self.new_data['Y'], test_size=0.2)
